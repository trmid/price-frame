...
// Prices Object:
export let prices = { eth: [], bsc: [], poly: [], ftm: [], avax: [], cronos: [], op: [], arb: [] };
// Initializations:
 ...
 */
export const getChainTokenPrices = async (chain) => {
 ...
 */
export const checkTokenPrice = (chain, address) => {
 ...
 */
export const queryCoinGeckoPrices = async (chain, addresses) => {
    // Initializations:
 ...
 * @param decimals - The token's decimals.
 */
export const query1InchPrice = async (chain, address, decimals) => {
 ...
 * @param decimals - The token's decimals.
 */
export const queryParaSwapPrice = async (chain, address, decimals) => {
    // Checking For Compatibility:
 ...
 */
export const updatePrices = (chain, priceData) => {
